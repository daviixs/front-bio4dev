...
// node_modules/react-grab/dist/chunk-KXX6WKZA.js
var IS_DEV = false;
...
var mountRoot = (cssText) => {
  ...
  if (mountedHost) {
    const mountedRoot = (_a = mountedHost.shadowRoot) == null ? void 0 : _a.querySelector(
      `[${ATTRIBUTE_NAME}]`
    );
...
var _tmpl$ = template(`<div style=overflow:visible>`);
...
var _tmpl$2 = template(`<canvas class="fixed top-0 left-0 pointer-events-none z-[2147483645]">`);
var Crosshair = (props) => {
  let canvasRef;
  let context = null;
  let width = 0;
...
var _tmpl$3 = template(`<svg xmlns=http://www.w3.org/2000/svg viewBox="0 0 24 24"fill=none stroke=currentColor stroke-linecap=round stroke-linejoin=round stroke-width=2><path d="M12 6H6a2 2 0 0 0-2 2v10a2 2 0 0 0 2 2h10a2 2 0 0 0 2-2v-6"></path><path d="M11 13l9-9"></path><path d="M15 4h5v5">`);
var IconOpen = (props) => {
...
var _tmpl$4 = template(`<svg xmlns=http://www.w3.org/2000/svg viewBox="0 0 24 24"fill=none stroke=currentColor stroke-width=2 stroke-linecap=round stroke-linejoin=round><path d="M12 2a3 3 0 0 0-3 3v7a3 3 0 0 0 6 0V5a3 3 0 0 0-3-3Z"></path><path d="M19 10v2a7 7 0 0 1-14 0v-2"></path><line x1=12 x2=12 y1=19 y2=22>`);
var IconMic = (props) => {
  const size = () => props.size ?? 12;
  return (() => {
    var _el$ = _tmpl$4();
...
var _tmpl$42 = template(`<div class="absolute w-0 h-0"style="border-left:8px solid transparent;border-right:8px solid transparent">`);
var _tmpl$52 = template(`<div role=button><div class="text-black text-[12px] leading-4 shrink-0 tracking-[-0.04em] font-sans font-medium w-fit h-fit">`);
...
var _tmpl$14 = template(`<div class="contain-layout shrink-0 flex items-center gap-px w-fit h-fit">`);
var _tmpl$15 = template(`<div class="contain-layout shrink-0 flex items-center gap-1 w-fit h-fit"><span class="text-label-muted text-[12px] leading-4 shrink-0 tracking-[-0.04em] font-sans font-medium w-fit h-fit">Press</span><div class="contain-layout shrink-0 flex flex-col items-start px-[3px] py-[3px] rounded-xs bg-white [border-width:0.5px] border-solid border-[#B3B3B3] size-fit"></div><span class="text-label-muted text-[12px] leading-4 shrink-0 tracking-[-0.04em] font-sans font-medium w-fit h-fit">to edit`);
var _tmpl$16 = template(`<div class="contain-layout shrink-0 flex flex-col justify-center items-start gap-1 w-fit h-fit"><div></div><div class="grid transition-[grid-template-rows] duration-30 ease-out self-stretch"><div>`);
var _tmpl$17 = template(`<button>`);
var _tmpl$18 = template(`<button class="contain-layout shrink-0 flex flex-col items-start px-[3px] py-[3px] rounded-xs bg-white [border-width:0.5px] border-solid border-[#B3B3B3] size-fit cursor-pointer transition-all hover:scale-105">`);
...
var TagBadge = (props) => {
  ...
  const handleMouseEnter = () => {
    var _a;
    setIsHovered(true);
    (_a = props.onHoverChange) == null ? void 0 : _a.call(props, true);
  };
  const handleMouseLeave = () => {
    var _a;
    setIsHovered(false);
    (_a = props.onHoverChange) == null ? void 0 : _a.call(props, false);
  };
  return (() => {
...
var SelectionLabel = (props) => {
  ...
  const speechRecognition = useSpeechRecognition({
    onTranscript: (transcript) => {
      var _a;
      return (_a = props.onInputChange) == null ? void 0 : _a.call(props, transcript);
    },
  ...
  const handleGlobalKeyDown = (event) => {
    ...
    if (event.code === "Enter" && isIdle() && !props.isInputExpanded && isNotProcessing()) {
      ...
      (_a = props.onToggleExpand) == null ? void 0 : _a.call(props);
    }
  };
  onMount(() => {
    measureContainer();
  ...
  const handleKeyDown = (event) => {
    ...
    if (event.code === "Enter" && !event.shiftKey) {
      event.preventDefault();
      if (!((_a = props.inputValue) == null ? void 0 : _a.trim())) return;
      speechRecognition.stop();
      (_b = props.onSubmit) == null ? void 0 : _b.call(props);
    } else if (event.code === "Escape") {
      event.preventDefault();
      speechRecognition.stop();
      (_c = props.onCancel) == null ? void 0 : _c.call(props);
    }
  };
  const handleInput = (event) => {
    var _a;
    const target = event.target;
    (_a = props.onInputChange) == null ? void 0 : _a.call(props, target.value);
  };
  ...
  const handleSubmit = () => {
    var _a, _b;
    if (props.isInputExpanded && !((_a = props.inputValue) == null ? void 0 : _a.trim())) return;
    speechRecognition.stop();
    (_b = props.onSubmit) == null ? void 0 : _b.call(props);
  };
                ...
                get children() {
                  ...
                  insert(_el$18, createComponent(Show, {
                    ...
                    get children() {
                      ...
                      _el$19.$$click = () => {
                        var _a;
                        return (_a = props.onUndo) == null ? void 0 : _a.call(props);
                      };
                      return _el$19;
                    }
                  }), null);
                  insert(_el$18, createComponent(Show, {
                    ...
                    get children() {
                      ...
                      _el$20.$$click = () => {
                        var _a;
                        return (_a = props.onDismiss) == null ? void 0 : _a.call(props);
                      };
                      return _el$20;
                    }
                  }), null);
              ...
              insert(_el$26, createComponent(Show, {
                ...
                get children() {
                  ...
                  _el$28.$$click = (event) => {
                    var _a;
                    event.stopPropagation();
                    (_a = props.onAbort) == null ? void 0 : _a.call(props);
                  };
...
var _tmpl$23 = template(`<div class="fixed z-2147483647"><button data-react-grab-selection-cursor>`);
...
var ReactGrabRenderer = (props) => {
  ...
  return [createComponent(Show, {
    ...
    children: (session) => [createComponent(Show, {
      ...
      onAbort: () => {
        var _a;
        return (_a = props.onAbortSession) == null ? void 0 : _a.call(props, session().id);
      },
      get onDismiss() {
        return session().isStreaming ? void 0 : () => {
          var _a;
          return (_a = props.onDismissSession) == null ? void 0 : _a.call(props, session().id);
        };
      },
      get onUndo() {
        return session().isStreaming ? void 0 : () => {
          var _a;
          return (_a = props.onUndoSession) == null ? void 0 : _a.call(props, session().id);
        };
      }
    })]
  }), createComponent(Show, {
...
var s = false;
var c;
var l = (e2 = h()) => s ? true : (typeof e2.inject == `function` && (c = e2.inject.toString()), !!(c == null ? void 0 : c.includes(`(injected)`)));
...
var Pe = (e2) => {
  ...
  for (let t2 of n2.renderers.values()) try {
    let n3 = (_a = t2.findFiberByHostInstance) == null ? void 0 : _a.call(t2, e2);
    if (n3) return n3;
  } catch {
  }
...
var Z = (e2, t2) => {
  ...
  try {
    ...
    (r4 == null ? void 0 : r4.configurable) && Object.defineProperty(n3.DetermineComponentFrameRoot, `name`, { value: `DetermineComponentFrameRoot` });
...
var De = (e2, t2, n2) => {
  ...
  return n2.set(e2.functionName, i2 + 1), { ...e2, isServer: true, fileName: a3.fileName, lineNumber: a3.lineNumber, columnNumber: a3.columnNumber, source: (_a = e2.source) == null ? void 0 : _a.replace(E, `(${a3.fileName}:${a3.lineNumber}:${a3.columnNumber})`) };
};
var Oe = (e2) => {
  let t2 = [];
  return N(e2, (e3) => {
    ...
    t2.push({ componentName: n2, stackFrames: D(Ce((_a = e3._debugStack) == null ? void 0 : _a.stack)) });
  }, true), t2;
};
var Q = async (e2, t2 = true, n2) => {
  let r3 = Oe(e2), i2 = D(Se(e2)), a3 = Ee2(r3), o3 = /* @__PURE__ */ new Map(), s3 = i2.map((e3) => {
    var _a;
    let t3 = ((_a = e3.source) == null ? void 0 : _a.includes(E)) ?? false;
...
var getHTMLPreview = (element) => {
  ...
  const text = ((_a = element.innerText) == null ? void 0 : _a.trim()) ?? ((_b = element.textContent) == null ? void 0 : _b.trim()) ?? "";
  let attrsText = "";
...
var copyContent = (content, options) => {
  ...
  const metadata = JSON.stringify({
    ...
    content,
    timestamp: Date.now(),
    ...(options == null ? void 0 : options.prompt) && { prompt: options.prompt }
  });
  const copyHandler = (event) => {
    var _a2, _b;
    event.preventDefault();
    (_a2 = event.clipboardData) == null ? void 0 : _a2.setData("text/plain", content);
    (_b = event.clipboardData) == null ? void 0 : _b.setData(REACT_GRAB_MIME_TYPE, metadata);
  };
...
var isTargetKeyCombination = (event, options) => {
  ...
  if (options.activationKey) {
    ...
    const keyMatches = ((_a = event.key) == null ? void 0 : _a.toLowerCase()) === key.toLowerCase() || keyMatchesCode(key, event.code);
...
var mergeThemeWithBase = (baseTheme, partialTheme) => {
  ...
  return {
    ...
    selectionBox: {
      enabled: ((_a = partialTheme.selectionBox) == null ? void 0 : _a.enabled) ?? baseTheme.selectionBox.enabled
    },
    dragBox: {
      enabled: ((_b = partialTheme.dragBox) == null ? void 0 : _b.enabled) ?? baseTheme.dragBox.enabled
    },
    grabbedBoxes: {
      enabled: ((_c = partialTheme.grabbedBoxes) == null ? void 0 : _c.enabled) ?? baseTheme.grabbedBoxes.enabled
    },
    elementLabel: {
      enabled: ((_d = partialTheme.elementLabel) == null ? void 0 : _d.enabled) ?? baseTheme.elementLabel.enabled
    },
    crosshair: {
      enabled: ((_e2 = partialTheme.crosshair) == null ? void 0 : _e2.enabled) ?? baseTheme.crosshair.enabled
    }
  };
};
...
var createAgentManager = (initialAgentOptions) => {
  ...
  const executeSessionStream = async (session, streamIterator) => {
    ...
    const storage = agentOptions == null ? void 0 : agentOptions.storage;
    ...
    try {
      for await (const status of streamIterator) {
        ...
        (_a = agentOptions == null ? void 0 : agentOptions.onStatus) == null ? void 0 : _a.call(agentOptions, status, updatedSession);
      }
      const finalSessions = sessions();
      const finalSession = finalSessions.get(session.id);
      if (finalSession) {
        const completionMessage = (_c = (_b = agentOptions == null ? void 0 : agentOptions.provider) == null ? void 0 : _b.getCompletionMessage) == null ? void 0 : _c.call(_b);
        ...
        (_d = agentOptions == null ? void 0 : agentOptions.onComplete) == null ? void 0 : _d.call(agentOptions, completedSession, element);
      }
    } catch (error) {
      const currentSessions = sessions();
      const currentSession = currentSessions.get(session.id);
      if (error instanceof Error && error.name === "AbortError") {
        ...
        if (currentSession) {
          const element = sessionElements.get(session.id);
          (_e2 = agentOptions == null ? void 0 : agentOptions.onAbort) == null ? void 0 : _e2.call(agentOptions, currentSession, element);
        }
      } else {
        ...
        if (isNetworkError) {
          ...
          if (currentSession) {
            ...
            if (error instanceof Error) {
              (_f = agentOptions == null ? void 0 : agentOptions.onError) == null ? void 0 : _f.call(agentOptions, error, errorSession);
            }
          }
        }
      }
  ...
  const tryResumeSessions = () => {
    ...
    if (!((_a = agentOptions == null ? void 0 : agentOptions.provider) == null ? void 0 : _a.supportsResume) || !agentOptions.provider.resume) {
      clearSessions(storage);
      return;
    }
    ...
    for (const existingSession of streamingSessions) {
      ...
      (_b = agentOptions == null ? void 0 : agentOptions.onResume) == null ? void 0 : _b.call(agentOptions, sessionWithResumeStatus);
  ...
  const startSession = async (params) => {
    ...
    const storage = agentOptions == null ? void 0 : agentOptions.storage;
    if (!(agentOptions == null ? void 0 : agentOptions.provider)) {
      return;
    }
    ...
    const context = {
      content,
      prompt,
      options: (_a = agentOptions == null ? void 0 : agentOptions.getOptions) == null ? void 0 : _a.call(agentOptions)
    };
    ...
    (_b = agentOptions.onStart) == null ? void 0 : _b.call(agentOptions, session, element);
    const abortController = new AbortController();
  ...
  const abortAllSessions = () => {
    ...
    clearSessions(agentOptions == null ? void 0 : agentOptions.storage);
  };
  ...
  const undoSession = (sessionId) => {
    ...
    if (session) {
      ...
      (_a = agentOptions == null ? void 0 : agentOptions.onUndo) == null ? void 0 : _a.call(agentOptions, session, element);
      void ((_c = (_b = agentOptions == null ? void 0 : agentOptions.provider) == null ? void 0 : _b.undo) == null ? void 0 : _c.call(_b));
    }
...
var _tmpl$24 = template(`<span class="tabular-nums align-middle">`);
var _tmpl$25 = template(`<span class="font-mono tabular-nums align-middle">&lt;<!>>`);
var _tmpl$33 = template(`<span class="tabular-nums ml-1 align-middle"> in `);
var onIdle = (callback) => {
...
var getScriptOptions = () => {
  ...
  try {
    const dataOptions = (_a = document.currentScript) == null ? void 0 : _a.getAttribute("data-options");
...
var init = (rawOptions) => {
  const initialTheme = mergeTheme(rawOptions == null ? void 0 : rawOptions.theme);
...
https://react-grab.com`, `background: #330039; color: #ffffff; border: 1px solid #d75fcb; padding: 4px 4px 4px 24px; border-radius: 4px; background-image: url("${logoDataUri}"); background-size: 16px 16px; background-repeat: no-repeat; background-position: 4px center; display: inline-block; margin-bottom: 4px;`, "");
  ...
  return createRoot((dispose2) => {
    ...
    const [hasAgentProvider, setHasAgentProvider] = createSignal(Boolean((_a = options.agent) == null ? void 0 : _a.provider));
    ...
    const showTemporaryGrabbedBox = (bounds, element) => {
      ...
      (_a2 = options.onGrabbedBox) == null ? void 0 : _a2.call(options, bounds, element);
      setTimeout(() => {
    ...
    const tryCopyWithFallback = async (elements, extraPrompt) => {
      ...
      let didCopy = false;
      let copiedContent = "";
      await ((_a2 = options.onBeforeCopy) == null ? void 0 : _a2.call(options, elements));
      try {
...
${plainTextContentOnly}` : plainTextContentOnly;
        ...
        if (didCopy) {
          (_b = options.onCopySuccess) == null ? void 0 : _b.call(options, elements, copiedContent);
        }
      } catch (error) {
        (_c = options.onCopyError) == null ? void 0 : _c.call(options, error);
        const plainTextContentOnly = createCombinedTextContent(elements);
        if (plainTextContentOnly.length > 0) {
          const contentWithPrompt = extraPrompt ? `${extraPrompt}
...
${plainTextContentOnly}` : plainTextContentOnly;
      ...
      (_d = options.onAfterCopy) == null ? void 0 : _d.call(options, elements, didCopy);
      return didCopy;
    };
    const copySingleElementToClipboard = async (targetElement2, extraPrompt) => {
      var _a2;
      (_a2 = options.onElementSelect) == null ? void 0 : _a2.call(options, targetElement2);
    ...
    const copyMultipleElementsToClipboard = async (targetElements) => {
      ...
      for (const element of targetElements) {
        (_a2 = options.onElementSelect) == null ? void 0 : _a2.call(options, element);
      }
      if (theme().grabbedBoxes.enabled) {
        for (const element of targetElements) {
    ...
    const labelContent = createMemo(() => {
      ...
      if (tagName && componentName) {
        return [(() => {
          var _el$2 = _tmpl$25(), _el$3 = _el$2.firstChild, _el$5 = _el$3.nextSibling;
          _el$5.nextSibling;
      ...
      if (tagName) {
        return (() => {
          var _el$8 = _tmpl$25(), _el$9 = _el$8.firstChild, _el$1 = _el$9.nextSibling;
          _el$1.nextSibling;
    ...
    createEffect(on(() => [targetElement(), lastGrabbedElement()], ([currentElement, lastElement]) => {
      ...
      if (currentElement) {
        (_a2 = options.onElementHover) == null ? void 0 : _a2.call(options, currentElement);
      }
    }));
    ...
    createEffect(on(() => [isInputMode(), mouseX(), mouseY(), targetElement()], ([inputMode, x3, y3, target]) => {
      var _a2;
      (_a2 = options.onInputModeChange) == null ? void 0 : _a2.call(options, inputMode, {
        x: x3,
        y: y3,
        targetElement: target
      });
    ...
    createEffect(on(() => [selectionVisible(), selectionBounds(), targetElement()], ([visible, bounds, element]) => {
      var _a2;
      (_a2 = options.onSelectionBox) == null ? void 0 : _a2.call(options, Boolean(visible), bounds ?? null, element);
    }));
    createEffect(on(() => [dragVisible(), dragBounds()], ([visible, bounds]) => {
      var _a2;
      (_a2 = options.onDragBox) == null ? void 0 : _a2.call(options, Boolean(visible), bounds ?? null);
    }));
    createEffect(on(() => [crosshairVisible(), mouseX(), mouseY()], ([visible, x3, y3]) => {
      var _a2;
      (_a2 = options.onCrosshair) == null ? void 0 : _a2.call(options, Boolean(visible), {
        x: x3,
        y: y3
      });
    }));
    createEffect(on(() => [labelVisible(), labelVariant(), labelContent(), cursorPosition()], ([visible, variant, content, position]) => {
      ...
      (_a2 = options.onElementLabel) == null ? void 0 : _a2.call(options, Boolean(visible), variant, {
        x: position.x,
        y: position.y,
    ...
    const activateRenderer = () => {
      ...
      setIsActivated(true);
      (_a2 = options.onActivate) == null ? void 0 : _a2.call(options);
    };
    const deactivateRenderer = () => {
      ...
      (_a2 = options.onDeactivate) == null ? void 0 : _a2.call(options);
    };
    ...
    const agentOptions = options.agent ? {
      ...
      onAbort: (session, element) => {
        var _a2, _b;
        (_b = (_a2 = options.agent) == null ? void 0 : _a2.onAbort) == null ? void 0 : _b.call(_a2, session, element);
        restoreInputFromSession(session, element);
      },
      onUndo: (session, element) => {
        var _a2, _b;
        (_b = (_a2 = options.agent) == null ? void 0 : _a2.onUndo) == null ? void 0 : _b.call(_a2, session, element);
        restoreInputFromSession(session, element);
      }
    } : void 0;
    ...
    const handlePointerDown = (clientX, clientY) => {
      ...
      (_a2 = options.onDragStart) == null ? void 0 : _a2.call(options, startX, startY);
      return true;
    };
    const handlePointerUp = (clientX, clientY) => {
      ...
      if (wasDragGesture) {
        ...
        if (selectedElements.length > 0) {
          (_a2 = options.onDragEnd) == null ? void 0 : _a2.call(options, selectedElements, dragRect);
    ...
    if ((originalKeyDescriptor == null ? void 0 : originalKeyDescriptor.get) && !originalKeyDescriptor.get.__reactGrabPatched) {
    ...
    const blockEnterIfNeeded = (event) => {
      const originalKey = (originalKeyDescriptor == null ? void 0 : originalKeyDescriptor.get) ? originalKeyDescriptor.get.call(event) : event.key;
    ...
    const copyElementAPI = async (elements) => {
      ...
      await ((_a2 = options.onBeforeCopy) == null ? void 0 : _a2.call(options, elementsArray));
      const didCopy = await tryCopyWithFallback(elementsArray);
      (_b = options.onAfterCopy) == null ? void 0 : _b.call(options, elementsArray, didCopy);
      return didCopy;
    };
    const getStateAPI = () => ({
    ...
    return {
      ...
      setAgent: (newAgentOptions) => {
        ...
        const mergedOptions = {
          ...existingOptions,
          ...newAgentOptions,
          provider: newAgentOptions.provider ?? (existingOptions == null ? void 0 : existingOptions.provider),
          onAbort: (session, element) => {
            var _a3;
            (_a3 = newAgentOptions == null ? void 0 : newAgentOptions.onAbort) == null ? void 0 : _a3.call(newAgentOptions, session, element);
            restoreInputFromSession(session, element);
          },
          onUndo: (session, element) => {
            var _a3;
            (_a3 = newAgentOptions == null ? void 0 : newAgentOptions.onUndo) == null ? void 0 : _a3.call(newAgentOptions, session, element);
            restoreInputFromSession(session, element);
          }
        };
        agentManager.setOptions(mergedOptions);
        setHasAgentProvider(Boolean(mergedOptions.provider));
        if ((_a2 = mergedOptions.provider) == null ? void 0 : _a2.checkConnection) {
...
// node_modules/react-grab/dist/index.js
var globalApi = null;
var getGlobalApi = () => {
...
export {
  ...
  getStack,
  init,
  Ee as isInstrumentationActive,
  setGlobalApi
};
/*! Bundled license information:

react-grab/dist/chunk-KXX6WKZA.js:
  (**
   * @license MIT
   *
