      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 gap-6">
          {technologies.map((tech: any, index: number) => (
            ...
            >
              <div
                className={`${tech.color || 'text-gray-700'} mb-3 group-hover:scale-110 transition-transform`}
              >
  ...
  return (
    <section className="py-20 px-6 bg-gradient-to-b from-gray-50 to-white">
      <div className="max-w-6xl mx-auto">
        {/* Título da Seção */}
        <div className="text-center mb-16">
          <h2 className="text-4xl mb-4 text-gray-900 font-bold">
                ...
                >
                  <div className="bg-white rounded-lg shadow-lg p-6 hover:shadow-xl transition-shadow duration-300 border border-gray-100">
                    ...
                    {work.technologies?.length > 0 && (
                      <div className="mb-4">
                        <h4 className="text-sm text-gray-900 mb-2 font-medium">
                          Tecnologias:
                        </h4>
                        <div
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {displayProjects.map((project: any, index: number) => (
            ...
            >
              ...
              <div className="p-6">
                <h3 className="mb-3 text-gray-800 text-xl font-semibold">
                  {project.nome}
                </h3>
