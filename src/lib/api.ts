...
api.interceptors.request.use((config) => {
  const token = localStorage.getItem('bio4dev_token');
  if (token) {
...
export const usersApi = {
  ...
  login: async (data: LoginDTO) => {
    const response = await api.post<{ message: string; user: User; token: string }>('/auth/login', data);
    return response.data;
  },
...
export const profileApi = {
  create: async (data: CreateProfileDTO) => {
    const response = await api.post<{ message: string; profile: Profile }>('/profile', data);
    return response.data;
  },
  
  update: async (id: string, data: UpdateProfileDTO) => {
    const response = await api.post<{ message: string; profile: Profile }>(`/profile/${id}`, data);
    return response.data;
  },
  ...
  getByUsername: async (username: string) => {
    const response = await api.get<ProfileComplete>(`/profile/username/${username}`);
    return response.data;
  },
...
export const legendaApi = {
  create: async (data: CreateLegendaDTO) => {
    const response = await api.post<{ message: string; legenda?: Legenda }>('/legenda', data);
    return response.data;
  },
  
  update: async (id: string, data: Partial<CreateLegendaDTO>) => {
    const response = await api.patch<{ message: string; legenda: Legenda }>(`/legenda/${id}`, data);
    return response.data;
  },
...
export const configApi = {
  create: async (data: CreateConfigDTO) => {
    const response = await api.post<{ message: string; config: Config }>('/config', data);
    return response.data;
  },
  
  update: async (id: string, data: Partial<CreateConfigDTO>) => {
    const response = await api.post<{ message: string; config: Config }>(`/config/${id}`, data);
    return response.data;
  },
...
export const pagesApi = {
  create: async (data: CreatePageDTO) => {
    const response = await api.post<{ message: string; page: Page }>('/pages', data);
    return response.data;
  },
  
  update: async (id: string, data: Partial<CreatePageDTO>) => {
    const response = await api.patch<{ message: string; page: Page }>(`/pages/${id}`, data);
    return response.data;
  },
...
export const socialApi = {
  create: async (data: CreateSocialDTO) => {
    const response = await api.post<{ message: string; social: Social }>('/social', data);
    return response.data;
  },
  
  update: async (id: string, data: Partial<CreateSocialDTO>) => {
    const response = await api.patch<{ message: string; social: Social }>(`/social/${id}`, data);
    return response.data;
  },
...
export const projetosApi = {
  create: async (data: CreateProjetoDTO) => {
    const response = await api.post<{ message: string; projeto: Projeto }>('/projetos', data);
    return response.data;
  },
  
  update: async (id: string, data: Partial<CreateProjetoDTO>) => {
    const response = await api.patch<{ message: string; projeto: Projeto }>(`/projetos/${id}`, data);
    return response.data;
  },
