...
export const PROFILES: ProfileData[] = [
  {
    ...
    buttonStyle:
      'bg-white/10 hover:bg-white/20 border border-white/20 backdrop-blur-md rounded-xl transition-all duration-300',
    ...
    buttons: [
      {
        label: 'Meu Plano de Treinamento',
        url: '#',
        subtext: 'Aprenda como comecei',
      },
      { label: 'Loja Oficial - Equipamentos', url: '#' },
      {
        label: 'Resultados da Última Prova',
        url: '#',
        subtext: '1º Lugar Maratona SP 2024',
      },
  ...
  },
  {
    ...
    backgroundStyle:
      "bg-[url('https://picsum.photos/seed/night/800/1200')] bg-cover bg-center",
    buttonStyle:
    ...
    buttons: [
      {
        label: "Ouça 'Midnight Sun' no Spotify",
        url: '#',
        subtext: 'Single novo já disponível!',
      },
    ...
    buttons: [
      {
        ...
        url: '#',
        subtext: 'Vídeos novos toda terça e quinta',
      },
      { label: 'Meu Setup (Peças & Links)', url: '#' },
      {
        label: 'Comunidade no Discord',
        url: '#',
        subtext: 'Mais de 10k membros',
      },
  ...
  },
  {
    ...
    buttons: [
      {
        label: 'Peça via WhatsApp',
        url: '#',
        subtext: 'Entregas das 08h às 18h',
      },
  ...
  },
  {
    ...
    buttons: [
      {
        label: 'Curso Grátis: Horta Urbana',
        url: '#',
        subtext: 'Vagas abertas para o próximo mês',
      },
      { label: 'Guia de Reciclagem PDF', url: '#' },
      {
        label: 'Apoie o Projeto Comunitário',
        url: '#',
        subtext: 'Contribua com o Jardim Coletiv,,,o',
      },
