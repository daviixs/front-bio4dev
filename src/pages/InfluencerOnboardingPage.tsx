...
import { GoogleAuthGate } from '@/components/shared/GoogleAuthGate';
  ...
  return (
    <div className={onboardingChrome.root}>
      ...
      <GoogleAuthGate
        ...
        title="Seu perfil esta quase pronto"
        body="Entre com Google para salvar seu primeiro perfil e concluir criacao automaticamente."
