        ...
        <div className="space-y-4 pt-4">
              ...
              {filteredTechs.length === 0 && (
                <div className="col-span-2 text-center py-8 text-slate-500 text-sm">
                  ...
                  <p className="mt-1 text-xs">
                    Clique em "Adicionar" para adicionar "{search}" mesmo assim.
                  </p>
                </div>
              )}
            </div>
          ...
          <div className="flex justify-end gap-2">
            ...
            <Button onClick={handleAdd} disabled={!search && !selectedTech}>
              Adicionar{" "}
              {selectedTech ? selectedTech.name : search ? `"${search}"` : ""}
            </Button>
          </div>
        </div>
      </DialogContent>
...
export function PortfolioEditorPage() {
  ...
  useEffect(() => {
    const loadProfile = async () => {
      // Aqui o portfolioId é na verdade o ID do perfil no banco de dados
      if (!portfolioId) {
        setIsLoading(false);
        return;
      }
      ...
      try {
        ...
        setTemplateType(profile.templateType);

        // Carregar dados de acordo com o templateType
        if (profile.templateType === "template_01") {
          // Carregar dados do perfil, ou usar dados padrão se não existirem
          ...
          if (hasData) {
            ...
            setPortfolioData({
              hero: {
                ...
                tagline: legenda?.titulo || "Desenvolvedor",
                description: legenda?.descricao || "Descrição do perfil",
                avatarUrl:
                  profile.avatarUrl ||
              ...
              techStack: {
                ...
                technologies:
                  profile.techStack?.technologies?.map((tech: any) => ({
                    name: tech.name,
                    icon: tech.icon,
                    color: tech.color || "text-blue-500",
                  })) || [],
              },
              workHistory:
              ...
              projects:
                profile.projetos?.map((proj: any) => ({
                  ...
                  githubUrl: proj.codeLink,
                })) || [],
              footer: {
                title: profile.footer?.title || "Vamos trabalhar juntos?",
                subtitle: profile.footer?.subtitle || "Entre em contato",
                email: profile.footer?.email || "",
                github: profile.footer?.github || "",
                linkedin: profile.footer?.linkedin || "",
                twitter: profile.footer?.twitter || "",
                copyrightName:
                  profile.footer?.copyrightName || profile.username,
                madeWith: "Feito com 💙",
              },
            });
          } else {
            // Usar dados mockados iniciais
            setPortfolioData({
              hero: {
                greeting: "Olá, eu sou",
                name: "João Silva",
              ...
              projects: [
                {
                  ...
                  imageUrl:
                    "https://media.giphy.com/media/v1.Y2lkPTc5MGI3NjExcHY5b3BkcHVucXVtOWt6OWN0YzR4ZjF6OWN5dTNxYzJ6ZjJ6ZjJ6ZiZlcD12MV9pbnRlcm5hbF9naWZfYnlfaWQmY3Q9Zw/26tn33aiTi1jkl6H6/giphy.gif",
                },
                {
                  ...
                  imageUrl:
                    "https://media.giphy.com/media/v1.Y2lkPTc5MGI3NjExYnVxdW5lcmJzenFrdHZmZnR6OWN0YzR4ZjF6OWN5dTNxYzJ6ZjJ6ZiZlcD12MV9pbnRlcm5hbF9naWZfYnlfaWQmY3Q9Zw/3oKIPEqDGUULpEU0aQ/giphy.gif",
                },
                {
                  ...
                  imageUrl:
                    "https://media.giphy.com/media/v1.Y2lkPTc5MGI3NjExYnVxdW5lcmJzenFrdHZmZnR6OWN0YzR4ZjF6OWN5dTNxYzJ6ZjJ6ZiZlcD12MV9pbnRlcm5hbF9naWZfYnlfaWQmY3Q9Zw/l0HlBO7eyXzSZkJri/giphy.gif",
                },
                {
                  title: "Rede Social",
                  description:
                  ...
                  imageUrl:
                    "https://media.giphy.com/media/v1.Y2lkPTc5MGI3NjExYnVxdW5lcmJzenFrdHZmZnR6OWN0YzR4ZjF6OWN5dTNxYzJ6ZjJ6ZiZlcD12MV9pbnRlcm5hbF9naWZfYnlfaWQmY3Q9Zw/3o7TKP9ln2Dr6ze6f6/giphy.gif",
                },
                {
                  title: "Clone Netflix",
                  description:
                  ...
                  imageUrl:
                    "https://media.giphy.com/media/v1.Y2lkPTc5MGI3NjExYnVxdW5lcmJzenFrdHZmZnR6OWN0YzR4ZjF6OWN5dTNxYzJ6ZjJ6ZiZlcD12MV9pbnRlcm5hbF9naWZfYnlfaWQmY3Q9Zw/xT0xeJpnrWC4XWblEk/giphy.gif",
                },
                {
                  title: "Portfolio 3D",
                  description:
                  ...
                  imageUrl:
                    "https://media.giphy.com/media/v1.Y2lkPTc5MGI3NjExYnVxdW5lcmJzenFrdHZmZnR6OWN0YzR4ZjF6OWN5dTNxYzJ6ZjJ6ZiZlcD12MV9pbnRlcm5hbF9naWZfYnlfaWQmY3Q9Zw/26BRzozg4TCBXv6QU/giphy.gif",
                },
              ],
              footer: {
          ...
          if (hasData) {
            ...
            setPortfolioData({
              profile: {
                ...
                role:
                  profile.legendas?.[0]?.titulo ||
                  "Product Designer & Developer",
                tagline:
                  profile.legendas?.[0]?.subtitulo ||
  ...
  const handleSave = async () => {
    if (!portfolioData || !profileId || !currentProfile) {
      toast.error("Dados do portfólio não encontrados");
      return;
    }

    // Validar se profileId é um UUID válido
    const uuidRegex =
    ...
    try {
      ...
      console.log("ProfileId sendo usado:", profileId);

      // Salvar dados baseado no template
      if (templateType === "template_01" && "hero" in portfolioData) {
        const data = portfolioData as Portfolio1Data;

        // 1. Atualizar ou criar legenda (Hero section)
        const subtitulo = data.hero.tagline.substring(0, 255);

        try {
          if (currentProfile.legendas && currentProfile.legendas.length > 0) {
            const legendaId = currentProfile.legendas[0].id;
            await legendaApi.update(legendaId, {
              nome: data.hero.name,
              titulo: data.hero.tagline,
              subtitulo: subtitulo,
              descricao: data.hero.description,
              legendaFoto: data.hero.avatarUrl,
            });
          } else {
          ...
          throw new Error(
            `Erro na legenda: ${error.response?.data?.message || error.message}`
          );
        }

        // 2. Atualizar perfil (avatar)
        await profileApi.update(profileId, {
          avatarUrl: data.hero.avatarUrl,
        });

        // 3. Salvar Tech Stack
        if (data.techStack && data.techStack.technologies) {
          const techStackData = {
            title: data.techStack.title || "Tech Stack",
            subtitle:
              data.techStack.subtitle || "Minhas principais tecnologias",
            technologies: data.techStack.technologies.map((tech, index) => ({
              name: tech.name,
              icon: tech.icon,
        ...
        if (data.projects && Array.isArray(data.projects)) {
          // Deletar projetos existentes que não estão mais na lista
          const existingProjectIds =
            currentProfile.projetos?.map((p: any) => p.id) || [];
          const currentProjectIds = data.projects
            .filter((p: any) => p.id)
            .map((p: any) => p.id);

          for (const existingId of existingProjectIds) {
            if (!currentProjectIds.includes(existingId)) {
              await projetosApi.delete(existingId);
            }
          }

          // Atualizar ou criar projetos
        ...
        if (data.footer) {
          if (currentProfile.footer) {
            // Update - não precisa enviar profileId
            await footerApi.update(currentProfile.footer.id, {
              title: data.footer.title || "Let's Connect",
              subtitle: data.footer.subtitle || "Get in touch",
              email: data.footer.email,
              github: data.footer.github,
              linkedin: data.footer.linkedin,
              twitter: data.footer.twitter,
              copyrightName: data.footer.copyrightName || data.hero.name,
            });
          } else {
            // Create - precisa do profileId
            await footerApi.create({
              ...
              twitter: data.footer.twitter,
              copyrightName: data.footer.copyrightName || data.hero.name,
              madeWith: data.footer.madeWith || "Feito com 💙",
            });
          }
        }

        toast.success("Portfólio salvo com sucesso!");
      } else if (templateType === "template_02" && "profile" in portfolioData) {
        const data = portfolioData as Portfolio2Data;

        // 1. Atualizar perfil e legenda para template 2
        const subtitulo = data.profile.tagline.substring(0, 255);

        if (currentProfile.legendas && currentProfile.legendas.length > 0) {
          const legendaId = currentProfile.legendas[0].id;
          await legendaApi.update(legendaId, {
            nome: data.profile.name,
            titulo: data.profile.role,
            subtitulo: subtitulo,
            descricao: data.profile.location,
            legendaFoto: data.profile.avatarUrl,
          });
        } else {
          await legendaApi.create({
            profileId: profileId,
        ...
        // 3. Salvar Work Experience
        if (data.experience && Array.isArray(data.experience)) {
          // Deletar experiências que não estão mais na lista
          const existingExpIds =
            currentProfile.workHistory?.map((w: any) => w.id) || [];
          const currentExpIds = data.experience
            .filter((e: any) => e.id)
            .map((e: any) => e.id);

          for (const existingId of existingExpIds) {
            if (!currentExpIds.includes(existingId)) {
              await workExperienceApi.delete(existingId);
            }
          }

          // Atualizar ou criar experiências
        ...
        // 5. Salvar Links Sociais
        if (data.socialLinks && Array.isArray(data.socialLinks)) {
          const existingSocialIds =
            currentProfile.social?.map((s: any) => s.id) || [];
          const currentSocialIds = data.socialLinks
            .filter((s: any) => s.id)
            .map((s: any) => s.id);

          for (const existingId of existingSocialIds) {
            if (!currentSocialIds.includes(existingId)) {
              await socialApi.delete(existingId);
            }
          }
          ...
          for (let i = 0; i < data.socialLinks.length; i++) {
            ...
            if (social.id) {
              ...
              await socialApi.update(social.id, {
                plataforma: social.name.toLowerCase() as any,
                url: social.url,
                ordem: i,
              });
            } else {
  ...
  if (
    ...
    return (
      <div>
              ...
              <div className="flex items-center gap-4">
                ...
                <div>
                  <h1 className="text-xl font-bold text-white">
                    Editando Portfólio 1
                  </h1>
                  <p className="text-sm text-white/60">
                    Clique no ícone de caneta para editar os campos
                  </p>
                </div>
              </div>
              <Button
        ...
        {/* Preview Area */}
        <Portfolio1Editor
          data={portfolioData as Portfolio1Data}
          onDataChange={(updatedData) => setPortfolioData(updatedData)}
        />
      </div>
    );
  }
    ...
    return (
      <div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          <Portfolio2Editor
            data={portfolioData as Portfolio2Data}
            onDataChange={(updatedData) => setPortfolioData(updatedData)}
          />
        </div>
      </div>
...
function Portfolio1Editor({
  data,
  onDataChange,
}: {
  data: Portfolio1Data;
  onDataChange?: (data: Portfolio1Data) => void;
}) {
  ...
  return (
    ...
    >
      ...
      <section
        ...
        style={{
          backgroundColor:
            portfolioData.theme === "DARK" ? "#09090b" : "#ffffff",
        }}
      >
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-16">
            ...
            >
              ...
              >
                {portfolioData.techStack.subtitle}
              </p>
            </EditableWrapper>
          </div>
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 gap-6">
                ...
                <div className="absolute top-2 right-2 opacity-0 group-hover:opacity-100 transition-opacity">
                  <Button
                    ...
                    onClick={(e: React.MouseEvent) => {
                      e.stopPropagation();
                      const newTechs =
                        portfolioData.techStack.technologies.filter(
                          (_, i) => i !== index
                        );
                      setPortfolioData({
                        ...portfolioData,
            ...
            <div
              ...
              style={{
                borderColor:
                  portfolioData.theme === "DARK" ? "#1e293b" : "#e5e7eb",
                backgroundColor:
                  portfolioData.theme === "DARK" ? "#0f172a" : "transparent",
              }}
            >
              <div
            ...
            onAdd={(newTech) => {
              setPortfolioData({
                ...
                techStack: {
                  ...portfolioData.techStack,
                  technologies: [
                    ...portfolioData.techStack.technologies,
                    newTech,
                  ],
                },
              });
                    ...
                    >
                      <div className="absolute top-2 right-2 flex gap-2 z-10">
                        ...
                        <Button
                          ...
                          size="icon"
                          onClick={() => {
                            const newHistory = portfolioData.workHistory.filter(
                              (_, i) => i !== index
                            );
                            setPortfolioData({
                              ...portfolioData,
      ...
      <footer
        ...
        style={{
          backgroundColor:
            portfolioData.theme === "DARK" ? "#09090b" : "#111827",
          color: "#ffffff",
        }}
      >
        <div className="max-w-6xl mx-auto">
            ...
            <div className="flex flex-col md:flex-row items-center justify-between gap-4">
              ...
              >
                <p className="text-gray-400 text-center md:text-left">
                  ...
                  {portfolioData.footer.copyrightName}. Todos os direitos
                  reservados.
                </p>
              </EditableWrapper>
      ...
      <Dialog
        open={editingWorkIndex !== null}
        onOpenChange={(open: boolean) => !open && setEditingWorkIndex(null)}
      >
            ...
            <div className="space-y-4 mt-4">
              ...
              <div>
                ...
                <Input
                  ...
                  onChange={(e) =>
                    setTempWork({ ...tempWork, period: e.target.value })
                  }
                  className="mt-2"
              ...
              <div>
                ...
                <Textarea
                  ...
                  onChange={(e) =>
                    setTempWork({ ...tempWork, summary: e.target.value })
                  }
              ...
              <div>
                ...
                <Textarea
                  ...
                  onChange={(e) =>
                    setTempWork({ ...tempWork, impact: e.target.value })
                  }
              ...
              <div className="flex justify-end gap-2 pt-4">
                <Button
                  variant="outline"
                  onClick={() => setEditingWorkIndex(null)}
                >
                  Cancelar
                </Button>
                <Button
      ...
      <ThemeCustomizer
        ...
        onColorChange={(c) =>
          setPortfolioData({ ...portfolioData, mainColor: c })
        }
      />
    </div>
  );
...
function Portfolio2Editor({
  data,
  onDataChange,
}: {
  data: Portfolio2Data;
  onDataChange?: (data: Portfolio2Data) => void;
}) {
  const [portfolioData, setPortfolioData] = useState(data);
  const [editingProjectIndex, setEditingProjectIndex] = useState<number | null>(
    null
  ...
  const [tempProject, setTempProject] = useState<
    Portfolio2Data["projects"][0] | null
  >(null);
  const [tempExperience, setTempExperience] = useState<
    Portfolio2Data["experience"][0] | null
  >(null);
      ...
      <main className="w-full max-w-md md:max-w-xl lg:max-w-2xl z-10 px-6 py-10 flex flex-col gap-6">
        ...
        <section className="grid grid-cols-2 gap-4">
          {portfolioData.socialLinks.map((link, index) => {
            ...
            const subTextColor = link.textColorClass
              ? "text-gray-600"
              : "text-gray-400";
              ...
              >
                ...
                >
                  <div className="flex justify-between items-start z-10">
                    ...
                    >
                      <IconComponent
                        size={22}
                        className={
                          link.id === "dev" ? "text-white" : "text-white"
                        }
                      />
                    </div>
                    <div
                      className={`p-1.5 rounded-full ${
                        link.id === "dev" ? "bg-gray-200" : "bg-white/10"
                      } opacity-0 group-hover:opacity-100 transition-opacity`}
                    >
                      <ArrowUpRight
                        size={18}
                        className={
                          link.id === "dev" ? "text-black" : "text-white"
                        }
                      />
                    </div>
                  </div>
                  ...
                  <div className="z-10">
                    ...
                    >
                      <p
                        className={`text-xs ${subTextColor} font-medium truncate mt-0.5`}
                      >
                        {link.handle}
                      </p>
                    </EditableWrapper>
              ...
              <div key={item.id} className="ml-6 relative group">
                ...
                <div className="flex justify-end gap-2 mb-2">
                  ...
                  <Button
                    ...
                    size="icon"
                    onClick={() => {
                      const newExp = portfolioData.experience.filter(
                        (_, i) => i !== index
                      );
                      setPortfolioData({
                        ...portfolioData,
        ...
        <section>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            {portfolioData.projects.map((project, index) => (
              <div
                key={project.id}
                className="bg-[#18181b] p-5 rounded-2xl border border-white/5 hover:border-yellow-500/30 transition-colors group relative"
              >
                <div className="absolute top-2 right-2 flex gap-2 z-10">
                  <Button
                    variant="ghost"
          ...
          <div className="flex flex-wrap gap-2">
            {portfolioData.techStack.map((tech, index) => (
              ...
              >
                ...
                <button
                  onClick={() => {
                    const newTechs = portfolioData.techStack.filter(
                      (_, i) => i !== index
                    );
          ...
          <AddTechDialog
            ...
            onAdd={(newTech) => {
              setPortfolioData({
                ...
                techStack: [
                  ...portfolioData.techStack,
                  { name: newTech.name, icon: newTech.icon },
                ],
              });
