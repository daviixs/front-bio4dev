  ...
  const handleFinish = async () => {
    ...
    try {
      ...
      for (const social of socials) {
        if (social.plataforma) {
          // Create social if it has a platform, even if URL is empty
            ...
            <div className="space-y-6">
              ...
              <div className="grid md:grid-cols-2 gap-6">
                <div className="space-y-2">
                  ...
                  <Input
                    ...
                    onChange={(e) =>
                      setLegenda({ ...legenda, legendaFoto: e.target.value })
                    }
                ...
                <div className="space-y-2">
                  ...
                  <Input
                    value={legenda.nome}
                    onChange={(e) =>
                      setLegenda({ ...legenda, nome: e.target.value })
                    }
                ...
                <div className="space-y-2">
                  ...
                  <Input
                    ...
                    onChange={(e) =>
                      setLegenda({ ...legenda, titulo: e.target.value })
                    }
                ...
                <div className="space-y-2">
                  ...
                  <Input
                    ...
                    onChange={(e) =>
                      setLegenda({ ...legenda, subtitulo: e.target.value })
                    }
              ...
              <div className="space-y-2">
                ...
                <Textarea
                  ...
                  onChange={(e) =>
                    setLegenda({ ...legenda, descricao: e.target.value })
                  }
