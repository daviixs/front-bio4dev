...
const INPUT_BASE = 'bg-white text-slate-900 placeholder:text-slate-400';

export const INFLUENCER_THEME_PRESETS: Record<ThemeId, InfluencerThemePreset> =
  {
    activist: {
      profile: {
      ...
      chrome: {
        page: 'bg-[radial-gradient(circle_at_top,rgba(16,185,129,0.14),transparent_34%)] bg-[#f4fbf6]',
        previewToolbar:
        ...
        buttonSecondary: `${LIGHT_SECONDARY_BASE} border-emerald-200 text-emerald-900 hover:bg-emerald-50`,
        input: `${INPUT_BASE} border-emerald-100 focus:border-emerald-500 focus:ring-emerald-500/20`,
    ...
    altmusic: {
      ...
      chrome: {
        page: 'bg-[radial-gradient(circle_at_top,rgba(24,24,27,0.12),transparent_34%)] bg-[#f5f4f4]',
        previewToolbar:
        ...
        buttonSecondary: `${LIGHT_SECONDARY_BASE} border-zinc-200 text-zinc-900 hover:bg-zinc-50`,
        input: `${INPUT_BASE} border-zinc-200 focus:border-zinc-500 focus:ring-zinc-500/20`,
    ...
    architect: {
      ...
      chrome: {
        page: 'bg-[linear-gradient(to_right,rgba(15,23,42,0.05)_1px,transparent_1px),linear-gradient(to_bottom,rgba(15,23,42,0.05)_1px,transparent_1px)] bg-[size:32px_32px] bg-white',
        previewToolbar:
        ...
        buttonSecondary: `${LIGHT_SECONDARY_BASE} border-black/15 text-black hover:bg-zinc-100`,
        input: `${INPUT_BASE} border-zinc-200 focus:border-black focus:ring-black/10`,
    ...
    artist: {
      ...
      chrome: {
        page: 'bg-[radial-gradient(circle_at_top,rgba(168,85,247,0.1),transparent_34%)] bg-[#faf7fd]',
        previewToolbar:
        ...
        buttonSecondary: `${LIGHT_SECONDARY_BASE} border-purple-200 text-purple-900 hover:bg-purple-50`,
        input: `${INPUT_BASE} border-purple-100 focus:border-purple-500 focus:ring-purple-500/20`,
    ...
    athlete: {
      ...
      chrome: {
        page: 'bg-[radial-gradient(circle_at_top,rgba(37,99,235,0.12),transparent_34%)] bg-[#f3f6fb]',
        previewToolbar:
        ...
        buttonSecondary: `${LIGHT_SECONDARY_BASE} border-blue-200 text-blue-900 hover:bg-blue-50`,
        input: `${INPUT_BASE} border-blue-100 focus:border-blue-500 focus:ring-blue-500/20`,
    ...
    business: {
      ...
      chrome: {
        page: 'bg-[radial-gradient(circle_at_top,rgba(123,63,0,0.12),transparent_34%)] bg-[#f7f1e8]',
        previewToolbar:
        ...
        buttonSecondary: `${LIGHT_SECONDARY_BASE} border-[#D8C0A7] text-[#4A2C2A] hover:bg-[#F8EFE4]`,
        input: `${INPUT_BASE} border-[#E6D6C2] focus:border-[#7B3F00] focus:ring-[#7B3F00]/15`,
    ...
    creator: {
      ...
      chrome: {
        ...
        buttonSecondary: `${LIGHT_SECONDARY_BASE} border-slate-200 text-slate-900 hover:bg-slate-100`,
        input: `${INPUT_BASE} border-slate-200 focus:border-indigo-500 focus:ring-indigo-500/20`,
    ...
    ecofashion: {
      ...
      chrome: {
        page: 'bg-[radial-gradient(circle_at_top,rgba(107,123,91,0.12),transparent_34%)] bg-[#F1EEE7]',
        previewToolbar:
        ...
        buttonSecondary: `${LIGHT_SECONDARY_BASE} border-[#D7D0C4] text-[#4A3F35] hover:bg-[#F4F1EA]`,
        input: `${INPUT_BASE} border-[#D7D0C4] focus:border-[#6B7B5B] focus:ring-[#6B7B5B]/15`,
    ...
    gourmet: {
      ...
      chrome: {
        page: 'bg-[radial-gradient(circle_at_top,rgba(197,160,89,0.12),transparent_34%)] bg-[#f8f3ea]',
        previewToolbar:
        ...
        buttonSecondary: `${LIGHT_SECONDARY_BASE} border-[#D9C298] text-[#3B2B13] hover:bg-[#F6EBD7]`,
        input: `${INPUT_BASE} border-[#E7D8BC] focus:border-[#C5A059] focus:ring-[#C5A059]/15`,
    ...
    innovation: {
      ...
      chrome: {
        page: 'bg-[radial-gradient(circle_at_top,rgba(0,240,255,0.1),transparent_34%)] bg-[#f3fbfd]',
        previewToolbar:
        ...
        buttonSecondary: `${LIGHT_SECONDARY_BASE} border-[#7BE8F0] text-[#033B40] hover:bg-[#E0FCFF]`,
        input: `${INPUT_BASE} border-[#B9F6FA] focus:border-[#00F0FF] focus:ring-[#00F0FF]/15`,
    ...
    streamer: {
      ...
      chrome: {
        page: 'bg-[radial-gradient(circle_at_top,rgba(168,85,247,0.1),transparent_34%),radial-gradient(circle_at_bottom_right,rgba(6,182,212,0.08),transparent_28%)] bg-[#f8f5ff]',
        previewToolbar:
        ...
        buttonSecondary: `${LIGHT_SECONDARY_BASE} border-violet-200 text-violet-900 hover:bg-violet-50`,
        input: `${INPUT_BASE} border-violet-100 focus:border-violet-500 focus:ring-violet-500/20`,
